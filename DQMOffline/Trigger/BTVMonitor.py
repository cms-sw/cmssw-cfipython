...
def BTVMonitor(*args, **kwargs):
  mod = cms.EDProducer('BTVMonitor',
    FolderName = cms.string('HLT/BTV/default'),
    ...
    HTdefinition = cms.string('pt > 0 & abs(eta)<2.5'),
    vertexSelection = cms.string('!isFake'),
    bjetSelection = cms.string('pt > 30 & abs(eta)<2.4'),
    njets = cms.uint32(0),
