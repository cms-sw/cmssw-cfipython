...
def JetMonitor(*args, **kwargs):
  mod = cms.EDProducer('JetMonitor',
    ...
    jetSrc = cms.InputTag('ak4PFJetsPuppi'),
    corrector = cms.InputTag(''),
    ptcut = cms.double(30),
    ispfjettrg = cms.bool(True),
    iscalojettrg = cms.bool(False),
    ispuppijet = cms.bool(False),
    dr2cut = cms.double(0.16),
    isscoutingpfjettrg = cms.bool(False),
    doVariablebinning = cms.bool(False),
    JetIDQuality = cms.string('TIGHT'),
    JetIDVersion = cms.string('RUN3Scouting'),
    enableFullMonitoring = cms.bool(True),
    muoSelection = cms.string('pt > 30'),
    nmuons = cms.uint32(0),
