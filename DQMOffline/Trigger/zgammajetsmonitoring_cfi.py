...
zgammajetsmonitoring = cms.EDProducer('ZGammaplusJetsMonitor',
  FolderName = cms.string('HLT/JME/ZGammaPlusJets'),
  processName = cms.string('HLT'),
  triggerEventObject = cms.InputTag('hltTriggerSummaryAOD', '', 'HLT'),
