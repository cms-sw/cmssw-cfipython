...
ParticleNetJetTagMonitor = cms.EDProducer('ParticleNetJetTagMonitor',
  ...
  tagElectronID = cms.InputTag('egmGsfElectronIDsForDQM', 'cutBasedElectronID-Fall17-94X-V2-tight'),
  vetoElectronID = cms.InputTag('egmGsfElectronIDsForDQM', 'cutBasedElectronID-Fall17-94X-V2-loose'),
