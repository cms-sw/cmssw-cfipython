...
def BarrelValidator(*args, **kwargs):
  mod = cms.EDProducer('BarrelValidator',
    ...
    histoProducerAlgoBlock = cms.PSet(
      ...
      maxTotNsimClsperlay = cms.double(10),
      nintTotNsimClsperlay = cms.int32(50),
      minTotNClsperlay = cms.double(0),
      maxTotNClsperlay = cms.double(100),
      nintTotNClsperlay = cms.int32(10),
    ...
    label_tst = cms.VInputTag('ticlTrackstersCLUE3DBarrel'),
    label_simTS = cms.InputTag('ticlSimTrackstersBarrel'),
    label_simTSFromCP = cms.InputTag('ticlSimTrackstersBarrel', 'fromCPs'),
    ...
    allTracksterTracksterAssociatorsLabels = cms.VInputTag(
      'allBarrelTrackstersToSimTrackstersAssociationsByLCs:ticlTrackstersCLUE3DBarrelToticlSimTrackstersBarrel',
      'allBarrelTrackstersToSimTrackstersAssociationsByLCs:ticlSimTrackstersBarrelToticlTrackstersCLUE3DBarrel',
      'allBarrelTrackstersToSimTrackstersAssociationsByLCs:ticlTrackstersCLUE3DBarrelToticlSimTrackstersBarrelfromCPs',
      'allBarrelTrackstersToSimTrackstersAssociationsByLCs:ticlSimTrackstersBarrelfromCPsToticlTrackstersCLUE3DBarrel'
    ),
    allTracksterTracksterByHitsAssociatorsLabels = cms.VInputTag(
      'allBarrelTrackstersToSimTrackstersAssociationsByHits:ticlTrackstersCLUE3DBarrelToticlSimTrackstersBarrel',
      'allBarrelTrackstersToSimTrackstersAssociationsByHits:ticlSimTrackstersBarrelToticlTrackstersCLUE3DBarrel',
      'allBarrelTrackstersToSimTrackstersAssociationsByHits:ticlTrackstersCLUE3DBarrelToticlSimTrackstersBarrelfromCPs',
      'allBarrelTrackstersToSimTrackstersAssociationsByHits:ticlSimTrackstersBarrelfromCPsToticlTrackstersCLUE3DBarrel'
    ),
    ...
    simTrackstersMap = cms.InputTag('ticlSimTrackstersBarrel'),
