...
def TrackingNtuple(*args, **kwargs):
  mod = cms.EDAnalyzer('TrackingNtuple',
    ...
    seedUniqueCheck = cms.untracked.bool(True),
    seedAlgoDetect = cms.untracked.bool(True),
    seedAlgos = cms.optional.untracked.vuint32,
    includeTrackCandidates = cms.untracked.bool(False),
    addSeedCurvCov = cms.untracked.bool(False),
    includeAllHits = cms.untracked.bool(False),
    includeOnTrackHitData = cms.untracked.bool(False),
