...
def MtdTracksValidation(*args, **kwargs):
  mod = cms.EDProducer('MtdTracksValidation',
    ...
    btlMatchTimeChi2 = cms.InputTag('trackExtenderWithMTD', 'btlMatchTimeChi2'),
    etlMatchTimeChi2 = cms.InputTag('trackExtenderWithMTD', 'etlMatchTimeChi2'),
    btlMatchChi2 = cms.InputTag('trackExtenderWithMTD', 'btlMatchChi2'),
