...
pixelQuadrupletEDProducer = cms.EDProducer('PixelQuadrupletEDProducer',
  triplets = cms.InputTag('hitTripletEDProducer'),
  extraHitRZtolerance = cms.double(0.1),
  extraHitRPhitolerance = cms.double(0.1),
  extraPhiTolerance = cms.PSet(
    pt1 = cms.double(0.1),
    pt2 = cms.double(0.1),
    value1 = cms.double(999),
    value2 = cms.double(0.15),
