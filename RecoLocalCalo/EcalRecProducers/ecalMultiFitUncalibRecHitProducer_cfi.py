...
ecalMultiFitUncalibRecHitProducer = cms.EDProducer('EcalUncalibRecHitProducer',
  ...
  algoPSet = cms.PSet(
    ...
    outOfTimeThresholdGain12pEB = cms.double(2.5),
    outOfTimeThresholdGain12mEB = cms.double(2.5),
    outOfTimeThresholdGain61pEB = cms.double(2.5),
    outOfTimeThresholdGain61mEB = cms.double(2.5),
