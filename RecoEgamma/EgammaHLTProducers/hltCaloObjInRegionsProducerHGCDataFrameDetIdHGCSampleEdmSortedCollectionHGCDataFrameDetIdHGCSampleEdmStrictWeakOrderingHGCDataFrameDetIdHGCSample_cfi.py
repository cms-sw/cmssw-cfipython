...
hltCaloObjInRegionsProducerHGCDataFrameDetIdHGCSampleEdmSortedCollectionHGCDataFrameDetIdHGCSampleEdmStrictWeakOrderingHGCDataFrameDetIdHGCSample = cms.EDProducer('HLTHGCalDigisInRegionsProducer',
