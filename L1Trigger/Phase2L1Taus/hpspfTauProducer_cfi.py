...
hpspfTauProducer = cms.EDProducer('HPSPFTauProducer',
  ...
  srcL1PFCands = cms.InputTag('l1ctLayer1', 'PF'),
  ...
  srcL1Vertices = cms.InputTag('L1VertexFinderEmulator', 'l1verticesEmulation'),
  ...
  srcL1Jets = cms.InputTag('l1tPhase1JetProducer', 'UncalibratedPhase1L1TJetFromPfCandidates'),
