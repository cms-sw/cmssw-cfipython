...
def alpaka_serial_sync_PixelCPEFastParamsESProducerAlpakaHIonPhase1(*args, **kwargs):
  mod = cms.ESProducer('alpaka_serial_sync::PixelCPEFastParamsESProducerAlpakaHIonPhase1',
