...
def alpaka_cuda_async_PixelCPEFastParamsESProducerAlpakaPhase2(*args, **kwargs):
  mod = cms.ESProducer('alpaka_cuda_async::PixelCPEFastParamsESProducerAlpakaPhase2',
