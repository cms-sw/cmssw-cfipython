...
def alpaka_serial_sync_PixelCPEFastParamsESProducerAlpakaPhase1(*args, **kwargs):
  mod = cms.ESProducer('alpaka_serial_sync::PixelCPEFastParamsESProducerAlpakaPhase1',
