...
def alpaka_cuda_async_PixelCPEFastParamsESProducerAlpakaHIonPhase1(*args, **kwargs):
  mod = cms.ESProducer('alpaka_cuda_async::PixelCPEFastParamsESProducerAlpakaHIonPhase1',
