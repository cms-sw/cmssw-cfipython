...
def alpaka_rocm_async_PixelCPEFastParamsESProducerAlpakaHIonPhase1(*args, **kwargs):
  mod = cms.ESProducer('alpaka_rocm_async::PixelCPEFastParamsESProducerAlpakaHIonPhase1',
