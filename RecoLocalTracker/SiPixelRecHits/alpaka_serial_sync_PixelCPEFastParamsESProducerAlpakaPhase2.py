...
def alpaka_serial_sync_PixelCPEFastParamsESProducerAlpakaPhase2(*args, **kwargs):
  mod = cms.ESProducer('alpaka_serial_sync::PixelCPEFastParamsESProducerAlpakaPhase2',
