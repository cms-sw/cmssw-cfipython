...
def alpaka_rocm_async_PixelCPEFastParamsESProducerAlpakaPhase1(*args, **kwargs):
  mod = cms.ESProducer('alpaka_rocm_async::PixelCPEFastParamsESProducerAlpakaPhase1',
