...
eopTreeWriter = cms.EDAnalyzer('EopTreeWriter',
  ...
  TrackAssociatorParameters = cms.PSet(
    ...
    EBRecHitCollectionLabel = cms.InputTag('IsoProd', 'IsoTrackEcalRecHitCollection'),
    EERecHitCollectionLabel = cms.InputTag('IsoProd', 'IsoTrackEcalRecHitCollection'),
    GEMSegmentCollectionLabel = cms.InputTag('gemSegments'),
    HBHERecHitCollectionLabel = cms.InputTag('IsoProd', 'IsoTrackHBHERecHitCollection'),
    HORecHitCollectionLabel = cms.InputTag('IsoProd', 'IsoTrackHORecHitCollection'),
