...
def AlignmentTrackSelectorModule(*args, **kwargs):
  mod = cms.EDFilter('AlignmentTrackSelectorModule',
    ...
    nLostHitMax = cms.double(999),
    nHitMin2D = cms.uint32(0),
    RorZofFirstHitMin = cms.vdouble(
      0,
      0
    ),
    RorZofFirstHitMax = cms.vdouble(
      999,
      999
    ),
    RorZofLastHitMin = cms.vdouble(
      0,
      0
    ),
    RorZofLastHitMax = cms.vdouble(
      999,
      999
    ),
    ...
    maxHitDiffEndcaps = cms.double(999),
    ...
    TwoBodyDecaySelector = cms.PSet(
      ...
      maxXMass = cms.double(15000),
      minXMass = cms.double(0),
      acoplanarDistance = cms.double(1),
