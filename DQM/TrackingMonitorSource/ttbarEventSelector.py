...
def ttbarEventSelector(*args, **kwargs):
  mod = cms.EDFilter('ttbarEventSelector',
    ...
    maxEtaMu = cms.untracked.double(2.4),
    ...
    maxEtaHighest_Jets = cms.untracked.double(2.4),
    maxEta_Jets = cms.untracked.double(3),
