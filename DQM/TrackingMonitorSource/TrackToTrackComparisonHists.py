...
def TrackToTrackComparisonHists(**kwargs):
  mod = cms.EDProducer('TrackToTrackComparisonHists',
    ...
    histoPSet = cms.PSet(
      ...
      onlinelumi_rangeMin = cms.double(0),
      onlinelumi_rangeMax = cms.double(20000),
      onlinelumi_nbin = cms.uint32(200),
      PU_rangeMin = cms.double(0),
      PU_rangeMax = cms.double(120),
      PU_nbin = cms.uint32(120)
    ),
