...
ppsAlignmentConfigurationESSource = cms.ESSource('PPSAlignmentConfigurationESSource',
  ...
  min_RP_tracks_size = cms.uint32(1),
  max_RP_tracks_size = cms.uint32(1),
  n_si = cms.double(4),
  matching = cms.PSet(
  ...
  binning = cms.PSet(
    ...
    y_min = cms.double(-20),
    y_max = cms.double(20),
    diffFN_n_bins_x = cms.uint32(100),
    diffFN_x_min = cms.double(0),
    diffFN_x_max = cms.double(20),
    slice_n_bins_x = cms.uint32(100),
    slice_x_min = cms.double(-10),
    slice_x_max = cms.double(10),
    slice_n_bins_y = cms.uint32(100),
    slice_y_min = cms.double(-2),
    slice_y_max = cms.double(2)
  ),
